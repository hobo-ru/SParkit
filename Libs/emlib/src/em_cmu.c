...
void CMU_ClockDivSet(CMU_Clock_TypeDef clock, CMU_ClkDiv_TypeDef div)
{
  ...
  case CMU_LFBPRESC0_REG://here
    switch (clock)
    {
#if defined(_CMU_LFBPRESC0_LEUART0_MASK)
    case cmuClock_LEUART0://here
      EFM_ASSERT(div <= cmuClkDiv_8);
...
void CMU_ClockEnable(CMU_Clock_TypeDef clock, bool enable)
{
  ...
  case CMU_HFCORECLKEN0_EN_REG://here
  ...
  case CMU_LFBCLKEN0_EN_REG://here
    reg  = &(CMU->LFBCLKEN0);
...
void CMU_ClockSelectSet(CMU_Clock_TypeDef clock, CMU_Select_TypeDef ref)
{
  ...
  case CMU_LFBCLKSEL_REG://here
    ...
    if (selReg == CMU_LFACLKSEL_REG)//here
    {//here
      #if defined(_EFM32_TINY_FAMILY) || defined(_EFM32_GIANT_FAMILY) || defined(_EFM32_WONDER_FAMILY)
